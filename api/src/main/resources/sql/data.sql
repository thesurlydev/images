...
DELETE FROM images;
INSERT INTO images (id, user_id, path, status, type, file_size) VALUES ('32084e30-84a5-11ee-aed1-2b32021344f3', '1aeabbac-84a5-11ee-9c3b-37b635df60b6', 'test-path', 'processing', 'png', '1024') ON CONFLICT DO NOTHING;
